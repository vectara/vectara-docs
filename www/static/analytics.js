...
function loadLib() {
  ...
  const cdnLink = "https://cdn.rudderlabs.com/v1.1/rudder-analytics.min.js";
...
function initAnalytics(key, url) {
...
function trackPageLoad(opts) {
  ...
  const analytics = initAnalytics(rsKey, apiUrl);
