...
[index a document](/docs/1.0/api-reference/indexing-apis/indexing), it will consist of both a
...
[filter expression](/docs/1.0/learn/metadata-search-filtering/filter-overview) documentation.