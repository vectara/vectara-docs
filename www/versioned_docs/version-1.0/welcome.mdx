...
<Grid columns={2}>
  <TopicButton title="API Playground" href="/docs/1.0/rest-api/vectara-rest-api">
    Try out Vectara's REST APIs directly in your browser.
  </TopicButton>
  <TopicButton title="Quick Start tutorial" href="/docs/1.0/quickstart">
...
<p>
  <Config v="names.product" /> is an end-to-end platform for product builders to
  embed powerful generative AI capabilities into applications with extraordinary
  results. <Config v="names.product" /> offers significant improvements over
  traditional searches by understanding the context and meaning of your data.
  This revolutionary technology enables <Config v="names.product" /> to drive
