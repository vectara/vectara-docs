...
Welcome to Vectara! This section will help you start building your first 
application in minutes.

## New to Vectara?

1. **[Learn about Vectara](/docs/introduction)** - Understand our platform and its 
   capabilities.
...
2. **[Developer quickstart](/docs/developer-quickstart)** - Learn the basics of 
   corpora and queries.
3. **[Create your first agent](/docs/build/agent-os/agents-quickstart)** - Create your 
