...
<Grid columns={2}>
  <TopicButton title="API Playground V2" href="/docs/rest-api/vectara-rest-api-v-2">
...
<p>
  ...
  generative AI capabilities into applications with extraordinary 
...
If you're ready to dive into our APIs, make your way to our [**API Playground V2.0**](/docs/rest-api/vectara-rest-api-v-2)!
