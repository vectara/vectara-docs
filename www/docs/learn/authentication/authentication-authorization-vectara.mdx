...
<Grid columns={3}>
  <TopicButton title="Enterprise Access Patterns" href="/docs/learn/authentication/personas-and-access-patterns">
    <Spacer size="l" />
...
1. New to Vectara? Start with **[Enterprise Access Patterns](/docs/learn/authentication/personas-and-access-patterns)** to 
   identify your role.
