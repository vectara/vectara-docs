...
By enabling table querying during document ingestion, users can leverage 
Vectara’s advanced APIs to retrieve specific cells, compare semantic values, 
and gain actionable insights from tables in reports, filings, and other 
structured documents.

**Why it matters:** This feature addresses the challenge of retrieving precise 
information from tabular data, often buried in lengthy and complex reports. 
