...
## Subagents: Autonomous, Specialized Agents Inside Your Agents
...
bloat. Subagents solve this issue by providing a separation from the primary agent. 
Your parent agent stays focused while delegating work to highly specialized 
subagents that maintain an independent state, reasoning, and workflow.

**More information:**

* [Agent tools overview](/docs/agent-os/agent-tools-overview)
* [Subagents](/docs/agent-os/subagents)
