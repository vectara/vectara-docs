...
Vectara introduces Fuzzy Metadata Search across document metadata fields. This 
...
* [Metadata Query API Documentation](/docs/api-reference/search-apis/metadata-query)
