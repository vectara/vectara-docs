...
## Hallucination Correction Model (HCM) API

_April 24, 2025_

Vectara introduces the tech preview release of the Hallucination Correction 
Model (HCM) API, a new capability designed to evaluate and revise AI-generated 
summaries for factual accuracy. The HCM endpoint compares a generated summary 
...
commonly introduce inaccuracies or hallucinations. The HCM API offers a 
targeted solution by enabling automatic, explainable corrections to text 
based on reliable context—preserving the original phrasing wherever possible. 
...
**More information:**
* [Hallucination Correction Model](/docs/learn/hallucination-correction-model)
* [Hallucination Correction Model API Definition](/docs/api-reference/llms-apis/hcm)
