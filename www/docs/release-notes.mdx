...
Vectara releases our Mockingbird LLM designed for Retrieval Augmented 
Generation (RAG) scenarios. It offers enhanced accuracy and improved 
performance in summarizing large datasets, generating structured data, and 
...
**Why it matters:** This major update significantly improves the developer 
experience, making it easier to integrate Vectara into applications. The 
standardized error codes and improved defaults reduce development overhead and 
potential silent errors. While REST API v2 is a major improvement, Vectara 
...
Vectara now lets users format citations in summaries using Markdown or HTML, 
and include document and part level metadata directly in citation links. This 
feature is useful for enterprises wanting formatted, context-rich summaries 
for integrating generative responses into web-based applications and ensuring 
