...
summarization using custom prompt templates. 
...
You can ingest PDF table data with the Vectara Console, [File Upload API](/docs/api-reference/indexing-apis/file-upload/file-upload), 
