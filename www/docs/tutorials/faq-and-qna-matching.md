...
<CodePanel snippets={[{language: "json", code: `{
  ...
  }`}]} title="Index question in title field" layout="stacked" />
...
<CodePanel snippets={[{language: "json", code: `{
  ...
  }`}]} title="Query for similar questions" layout="stacked" />
...
You can also add a [filter expression](/docs/build/prepare-data/metadata-filters)
...
<CodePanel snippets={[{language: "json", code: `{
  ...
  }`}]} title="Combine question matching and answering" layout="stacked" />
