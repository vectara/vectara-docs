...
- A valid [Vectara API key](https://docs.vectara.com/docs/deploy-and-scale/authentication/api-key-management) with access to the [Chat Completions](/docs/rest-api/create-chat-completion) endpoint.
