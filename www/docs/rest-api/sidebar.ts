  ...
  apisidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "rest-api/list-tool-configurations",
          label: "List tool configurations",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "rest-api/create-tool-configuration",
          label: "Create tool configuration",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "rest-api/get-tool-configuration",
          label: "Get tool configuration",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "rest-api/update-tool-configuration",
          label: "Update tool configuration",
          className: "api-method patch",
        },
        {
          type: "doc",
          id: "rest-api/delete-tool-configuration",
          label: "Delete tool configuration",
          className: "api-method delete",
        },
        {
          type: "doc",
          id: "rest-api/delete-tool-configuration-version",
          label: "Delete tool configuration version",
          className: "api-method delete",
        },
      ],
    },
