...
((__t = (`+h1+`)) == null ? '' : __t) +
'`),F=j0+t1.length,t1}),D+=`';
`;var J=m1.call(n,"variable")&&n.variable;if(!J)D=`with (obj) {
`+D+`
}
...
.searchModalContainer .searchResultSnippet {
  ...
  line-height: 20px;
  margin-bottom: 0;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(xA));var t2=B(R()),yf=({customerId:t,apiKey:e,corpusId:r,apiUrl:i})=>{let[o,c]=(0,N0.useState)([]),[u,h]=(0,N0.useState)(null),[d,f]=(0,N0.useState)(!1),H=(0,N0.useRef)(null),w=(0,N0.useRef)(null),C=(0,N0.useRef)(""),A=(0,N0.useRef)(0),{fetchSearchResults:E,isLoading:M}=xf(t,r,e,i),S=async P=>{if(P.length===0)return;let U=++A.current,Y=await E(P);U===A.current&&(c(Y),h(null),w.current=null)},g=(0,wf.default)(P=>S(P),500),m=P=>{let U=P.target.value;C.current=U,U.length===0&&b(),g(U)},z=(0,N0.useCallback)(P=>{let U=P.key;U==="Enter"&&(P.preventDefault(),u!==null?window.open(o[u].url,"_self"):S(C.current)),o.length!==0&&(U==="ArrowDown"&&h(Y=>Y===null||Y===o.length-1?0:Y+1),U==="ArrowUp"&&h(Y=>Y===null||Y===0?o.length-1:Y-1))},[o,u]),b=()=>{c([]),h(null),w.current=null},I=()=>{f(!1),b()},T=o.length===0?null:o.map((P,U)=>{let{snippet:{pre:Y,text:r1,post:G1}}=P;return(0,t2.jsx)("div",{ref:u===U?w:void 0,children:(0,t2.jsx)(zf,{searchResult:P,isSelected:u===U})},`${Y}${r1}${G1}`)});return(0,N0.useEffect)(()=>{w.current&&w.current.scrollIntoView({behavior:"instant",block:"nearest"})},[w.current]),(0,N0.useEffect)(()=>{let P=U=>{U.key==="k"&&U.ctrlKey&&f(!0)};return document.addEventListener("keyup",P),()=>{document.removeEventListener("keyup",P)}},[]),(0,t2.jsxs)(zd,{children:[(0,t2.jsx)("div",{ref:H,children:(0,t2.jsx)(Mt,{color:"neutral",onClick:()=>f(!0),icon:(0,t2.jsx)(B1,{children:(0,t2.jsx)(ci,{})}),children:"Search"})}),(0,t2.jsx)(Mf,{isLoading:M,onChange:m,onKeyDown:z,isOpen:d,resultsList:T,onClose:I})]})};var Sf=B(R());(function(){var e=new MutationObserver(()=>{let r=window.vectara?.plugins?.search;if(!r)return;let{containerId:i,customerId:o,apiKey:c,corpusId:u}=r;if(!o||!c||!u){console.warn("Vectara Search: Customer ID, API key, and Corpus ID are required.");return}let h=document.getElementById(i??"search");h&&h.childNodes.length===0&&(console.log("### ATTACH!"),(0,Hf.createRoot)(h).render((0,Sf.jsx)(yf,{customerId:o,apiKey:c,corpusId:u})))});e.observe(document,{attributes:!1,childList:!0,characterData:!1,subtree:!0})})();
